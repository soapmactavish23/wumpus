...
function createMiniMap() {
  ...
  miniMapContainer.style.display = "block"; // Mostrar o minimapa para a versão 2
...
function chooseActionBasedOnPerceptions(perceptions) {
  ...
  if (perceptions.glitter) {
    return "grab";
  }
  if (perceptions.smell && hasArrow) {
    hasArrow = false; // Usa a flecha
    alert("Atirou a flecha!");
    return "shoot";
  }
  return randomAction;
}
